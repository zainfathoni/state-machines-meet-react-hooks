...
```jsx 50,57,59:60 title="4️⃣ Add List Screen 🗒" subtitle="4️⃣ Update Event Propagations"
import React, { useState } from 'react'
import { Button, Modal } from '../shared/Components'
...
```jsx 11:13,24:25 title="4️⃣ App with State Machine 🛠" subtitle="4️⃣ That's it!"
import React from 'react'
import { Button, Modal } from '../shared/Components'
import { useMachine } from '../shared/useMachine'
import { modalMachine } from './machine'
